...
\begin{table}[htbp]
  ...
  \begin{tabular}{>{\bfseries\raggedright\arraybackslash}p{4cm} >{\raggedright\arraybackslash}p{11.5cm}}
    \toprule
...
\begin{table}[htbp]
  ...
  \begin{tabular}{>{\bfseries\raggedright\arraybackslash}p{4.5cm} >{\raggedright\arraybackslash}p{11cm}}
    \toprule
