...
\begin{figure}[H]
    ...
    \caption{Diagrama de Clases de Negocio (Placeholder)}
    \label{fig:clases_negocio_placeholder}
    \par\vspace{0.2cm}
    \raggedright\noindent\small \emph{Nota.} Elaboración propia (2026). Este diagrama ilustra cómo el Administrador, Vendedor, Cajero y Encargado de almacén interactúan con las entidades clave de la empresa. [FALTA REEMPLAZAR IMAGEN POR EL DIAGRAMA DE VISUAL PARADIGM]
\end{figure}
