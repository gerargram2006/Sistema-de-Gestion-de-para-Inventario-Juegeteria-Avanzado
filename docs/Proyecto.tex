...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{media/diagrama_clases_negocio.png}
    \caption{Diagrama de Clases de Negocio}
    \label{fig:clases_negocio_placeholder}
    \par\vspace{0.2cm}
    \raggedright\noindent\small \emph{Nota.} Elaboración propia (2026). Este diagrama ilustra cómo el Administrador, Vendedor, Cajero y Encargado de almacén interactúan con las entidades clave de la empresa. 
\end{figure}

\subsection{Diagramas de Actividades del Negocio}
