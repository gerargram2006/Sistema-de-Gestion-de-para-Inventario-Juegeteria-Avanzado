...
\begin{table}[htbp]
  ...
  \end{tabularx}
  \par\vspace{1ex}
  \small \emph{Nota.} Elaboración propia (2026).
\end{table}
...
\begin{table}[htbp]
  ...
  \end{tabularx}
  \par\vspace{1ex}
  \small \emph{Nota.} Un listado de entidad de negocio con campos de descripción para cada parte.
\end{table}
...
\begin{figure}[H]
    ...
    \par\vspace{0.2cm}
    \raggedright \small \textit{Nota.} Elaboración propia (2026).
\end{figure}
...
\begin{figure}[H]
    ...
    \par\vspace{0.2cm}
    \raggedright \small \textit{Nota.} Elaboración propia (2026). Representación de la secuencia de acciones para procesar una venta.
\end{figure}
...
\begin{figure}[H]
    ...
    \par\vspace{0.2cm}
    \raggedright \small \textit{Nota.} Elaboración propia (2026). Representación del proceso de cotización y recepción de nuevos juguetes.
\end{figure}
...
\begin{figure}[H]
    ...
    \par\vspace{0.2cm}
    \raggedright \small \textit{Nota.} Elaboración propia (2026). Flujo de acciones para auditorías y actualización de stock.
\end{figure}
...
\begin{figure}[H]
    ...
    \par\vspace{0.2cm}
    \raggedright \small \textit{Nota.} Elaboración propia (2026). Secuencia de atención de incidencias, cambios de productos o reembolsos.
\end{figure}
...
\begin{figure}[H]
    ...
    \par\vspace{0.2cm}
    \raggedright \small \textit{Nota.} Elaboración propia (2026). Interacción entre los actores y trabajadores del negocio con los procesos clave.
\end{figure}
