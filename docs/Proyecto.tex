...
\begin{thebibliography}{9}
  ...
  \bibitem{banker2016}
  Banker, K., Bakkum, P., Verch, S., Garrett, D., y Hawkins, T. (2016).
  \emph{MongoDB in action} (2.\textsuperscript{a} ed.). Manning Publications.

  \bibitem{bradshaw2019}
  Bradshaw, S., Brazil, E., y Chodorow, C. (2019). \emph{MongoDB: The
  definitive guide: Powerful and scalable data storage} (3.\textsuperscript{a}
  ed.). O'Reilly Media.
  ...
  Pressman, R. S., y Maxim, B. R. (2021). \emph{Ingeniería del software: Un
  enfoque práctico} (9.\textsuperscript{a} ed.). McGraw-Hill Education.
  ...
  \bibitem{welling2017}
  Welling, L., y Thompson, L. (2017). \emph{PHP and MySQL web development}
  (5.\textsuperscript{a} ed.). Addison-Wesley Professional.

  \bibitem{wiegers2013}
  Wiegers, K., y Beatty, J. (2013). \emph{Software requirements}
  (3.\textsuperscript{a} ed.). Microsoft Press.
\end{thebibliography}
